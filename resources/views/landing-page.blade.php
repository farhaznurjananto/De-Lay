    ...
    <main>
      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="img-fluid w-100" src="https://source.unsplash.com/1600x400?soya-bean" alt="" style="height: 400px" />
            <div class="container">
      ...
      <div class="container my-5">
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">De-Lay</h2>
        ...
        <div class="row text-center" id="services">
          <h1 class="">Layanan</h1>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore neque voluptatem possimus asperiores! At nihil, nostrum aperiam cum tempora voluptatum maiores nemo, voluptate voluptatem vero reprehenderit, maxime laudantium
            officia suscipit numquam molestiae libero totam quisquam qui magnam ut! Hic porro nisi error nobis et amet! Voluptatibus odit minima repudiandae beatae quisquam rerum alias. Voluptatum, ullam voluptatibus aliquam doloremque
            voluptas natus?
          </p>
        ...
        <div class="row d-flex justify-content-center" id="product">
          ...
          <div class="card my-3 mx-3 p-0" style="max-width: 1080px">
            <div class="row g-0">
              <div class="col-md-4">
                <img class="img-fluid rounded-start h-100" src="https://source.unsplash.com/500x500?soya-bean-milk" alt="" />
              </div>
              <div class="col-md-8">
                <div class="card-body">
